...
gtsave(tab_sup1, here("writing", "tables", "tab_sup1.rtf"))
tab_sup1
```
...
gtsave(tab_1,
       here("writing", "tables", "tab_1.html"))
...
```{r}
ggsave(dist_orig,
       file = here("writing", "figures", "dist_orig.png"),
       dev = "png",
       width = 7,
       height = 9,
       dpi = 300)
...
ggsave(dist_trans,
       file = here("writing", "figures", "dist_trans.png"),
       dev = "png",
       width = 7,
       height = 9,
       dpi = 300)
...
ame_draws <- readRDS(here("models", "processed", "ame_draws.rds"))
...
ggsave(ame_plot,
       file = here("writing", "figures", "ame_plot.png"),
       dev = "png",
       width = 10,
       height = 8,
       dpi = 300)
...
ids_orig <- readRDS(here("models", "processed", "ame_draws.rds")) |>
  filter(y == "ids_total") |>
  mutate(gr = paste("Sleep\n", gr),
         y = "A")

ids_nosleep <-  readRDS(here("models", "processed", "ame_nosleep.rds")) |>
